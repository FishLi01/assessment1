...
public class AssessmentProject {
     ...
     * 项目名称
     */
    @ApiModelProperty(value = "项目名称",name = "projectName",example = "项目名称",required = true)
     ...
     * 委托方
     */
    @ApiModelProperty(value = "委托方",name = "client",example = "委托方",required = true)
     ...
     * 起始时间
     */
    @ApiModelProperty(value = "起始时间",name = "startingTime",example = "2021-01-01",required = true)
     ...
     * 结束时间
     */
    @ApiModelProperty(value = "结束时间",name = "endTime",example = "2021-12-30",required = true)
     ...
     * 应收金额
     */
    @ApiModelProperty(value = "应收金额",name = "amountReceivable",example = "100",required = true)
     ...
     * 创建项目用户ID
     */
    @ApiModelProperty(value = "创建项目用户ID",name = "userId",example = "",required = true)
    @Column(name = "user_id")
